...
const APP_NAME = process.env.APP_NAME ? process.env.APP_NAME : 'hzero-front';
const WEBSOCKET_HOST = process.env.WEBSOCKET_HOST || 'ws://dev.hzero.org:8120';
...
const IM_WEBSOCKET_HOST = process.env.IM_WEBSOCKET_HOST || 'ws://dev.hzero.org:9876';
const CUSTOMIZE_ICON_NAME = process.env.CUSTOMIZE_ICON_NAME || 'customize-icon';
